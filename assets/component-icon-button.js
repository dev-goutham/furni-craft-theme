...
/*!**********************************************!*\
  !*** ./src/ts/web-components/icon-button.ts ***!
  \**********************************************/
...
var IconButton = /*#__PURE__*/function (_HTMLButtonElement) {
  ...
  function IconButton() {
    ...
    (_this$shadowRoot = _this.shadowRoot) === null || _this$shadowRoot === void 0 ? void 0 : _this$shadowRoot.appendChild(iconButtonTemplate.content.cloneNode(true));
    return _this;
  }
  return _createClass(IconButton);
}( /*#__PURE__*/_wrapNativeSuper(HTMLButtonElement));
var iconButtonTemplate = document.createElement('template');
